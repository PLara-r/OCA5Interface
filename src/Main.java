...
//Java по существу открыла дверь к множественным проблемам наследования. 
//    Например, какое значение выдает следующий код?
...
//!!! a статические методы не наследуются подклассом и должны быть доступны со ссылкой на имя интерфейса.
//у статических методов интерфейса нет ни одной из тех же проблем и правил множественного наследования,
